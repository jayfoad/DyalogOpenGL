...
∇ {z}←glXChooseFBConfig x;p;n
  ...
  :Else
      :If 3≠⎕NC'glXChooseFBConfig_copyarray'
          'glXChooseFBConfig_copyarray'⎕NA'P ',#.DyalogXX.GetDLLName,'|MEMCPY >P[] P P'
      :EndIf
      z←⊃⌽glXChooseFBConfig_copyarray n p (n×8) ⍝ FIXME 4 for 32-bit
      #.Xlib.XFree p

      ⍝:If 3≠⎕NC'glXChooseFBConfig_copyfbconfig'
      ⍝    'glXChooseFBConfig_copyfbconfig'⎕NA'P ',#.DyalogXX.GetDLLName,'|MEMCPY >{I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 U4 U1 U1 U1 U1 U1 U1 U1 U1[1] I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 I4 U4 U4 U4 U4 U4 U4 I4 I4 U1 U1[7] F8 F8 F8 F8 F8 F8 F8 F8} P P'
      ⍝:EndIf
...
∇ {z}←glXGetVisualFromFBConfig x;p
  ...
  :If 3≠⎕NC'glXGetVisualFromFBConfig_copy'
      'glXGetVisualFromFBConfig_copy'⎕NA'P ',#.DyalogXX.GetDLLName,'|MEMCPY >{P P I4 I4 I4 U1[4] P P P I4 I4} P P'
  :EndIf
  z←⎕NS''
