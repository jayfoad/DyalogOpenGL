...
∇ {r}←glutCreateWindow title;bitand;dwFlags;pFD;handle;hDC;IPX;hRC
  r←⎕NEW System.Windows.Forms.Form
  r.Text←title
  :If ∧/initialwindowposition≥0
      r.StartPosition←System.Windows.Forms.FormStartPosition.Manual
      r.Location←⎕NEW System.Drawing.Point initialwindowposition
  :Endif
  :If ∧/initialwindowsize>0
      r.ClientSize←⎕NEW System.Drawing.Size initialwindowsize
  :Endif
  r.onClose←'#.GLUT.close'
